...
class CONSTANTS:
  ...
  S_TEMPLATE_ERROR_WEBSITE_PATH = "user/server/error/error.html"
  S_TEMPLATE_SITEMAP_WEBSITE_PATH = "user/interactive/sitemap/sitemap.html"
  S_TEMPLATE_SEARCH_WEBSITE_PATH = "user/interactive/search/search.html"
