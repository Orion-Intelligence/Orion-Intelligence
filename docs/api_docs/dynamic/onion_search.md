# Dynamic: dynamic_cross_search

## Description

Perform a dynamic Cross Search using a user-provided query string.  
The API submits the query to multiple search engines and returns raw results without UI rendering.
