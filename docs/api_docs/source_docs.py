...
SOCIAL_DOCS = {
    "extensions_version": {
        "description": "Retrieves the current version of the social reconnaissance extension deployed on the system. This endpoint corresponds to `GET /api/social/extensions/version`.\n\nThis endpoint does not require any request payload.",
        "response_description": "The API returns the extension version information.\n\nExample response:\n```json\n{\n  \"version\": \"1.2.5\",\n  \"status\": \"up_to_date\"\n}\n```",
    },
    "phone_recon": {
        "description": "Initiates a reconnaissance scan specifically targeting phone numbers across social media platforms, public directories, and other open-source intelligence sources. This endpoint corresponds to `POST /api/social/phone/recon`.\n\nSupported request fields:\n\n- **query** — The phone number to search for (include country code for best results).\n\nExample request payload:\n\n```json\n{\n  \"query\": \"+1234567890\"\n}\n```",
        "response_description": "The API returns a collection of identified accounts and online presence details associated with the phone number.\n\nExample response:\n```json\n{\n  \"result\": [\n    {\n      \"metadata\": {\n        \"platform\": \"whatsapp\",\n        \"status\": \"active\"\n      },\n      \"data\": {\n        \"title\": \"John Doe - WhatsApp Business\",\n        \"snippet\": \"Available\"\n      }\n    }\n  ]\n}\n```",
    },
    "profile_followers": {
        "description": "Scrapes and extracts the follower list of a specified social media account. This API allows for targeted data collection of an account's audience up to a user-defined limit, providing insights into community composition and user reach.\nThe API is primarily used for audience mapping, lead generation, and verifying account influence.\n\nSupported request fields:\n\n- **platform** — The target social media network\n- **username** — The profile handle to scrape\n- **max_followers** - The maximum number of **follower** records to retrieve\n\nExample request payload:\n\n```json\n{\n  \"platform\": \"Instagram\",\n  \"username\": \"sarcaxxm\",\n  \"max_followers\": 1000\n}\n```",
        "response_description": "The API returns a consolidated list of usernames following the target profile, along with the processing status and request metadata.\n\nField semantics for each element under **result**:\n\n- **followers** — An array of strings containing the usernames of the account's followers\n- **platform** — The social media network targeted in the request\n- **username** — The handle/username of the profile being scraped\n- **status** — The current operational status of the account or the task\n\nExample response:\n```json\n{\n    \"result\": {\n        \"followers\": [\n            \"userisun.stable\",\n            \"fatimahh_050\",\n            \"abdullah_affan34\",\n            \"munir.379\",\n            \"hamnaa._.111\",\n            \"ayeshaa2_6\"\n        ],\n        \"platform\": \"instagram\",\n        \"username\": \"sarcaxxm\",\n        \"status\": \"active\"\n    }\n}\n```",
    },
    "profile_following": {
        "description": "Scrapes and extracts the list of accounts that a specific social media user is currently following. This API allows for competitive analysis, interest mapping, and network connection discovery by retrieving follow lists up to a specified limit.\nThe API is ideal for identifying the influencers, brands, or communities that a specific target account engages with.\n\nSupported request fields:\n\n- **platform** — The target social media network\n- **username** — The profile handle to scrape\n- **max_following** - The maximum number of **following** records to retrieve\n\nExample request payload:\n\n```json\n{\n  \"platform\": \"Instagram\",\n  \"username\": \"sarcaxxm\",\n  \"max_following\": 1000\n}\n```",
        "response_description": "The API returns a structured object containing an array of usernames found in the \"following\" list, alongside the platform metadata and request status.\n\nField semantics for each element under **result**:\n\n- **following** — An array of strings representing the handles/usernames of accounts followed by the target\n- **platform** — The social media network targeted in the request\n- **username** — The handle/username of the profile being scraped\n- **status** — The current operational status of the account or the task\n\nExample response:\n```json\n{\n    \"result\": {\n        \"following\": [\n            \"mark_r1chard09\",\n            \"starboy_beastfire\",\n            \"lion_ettia\",\n            \"ariannacodes\",\n            \"adm_aint_coo\",\n            \"gregorycrowther160\",\n            \"instagram\"\n        ],\n        \"platform\": \"instagram\",\n        \"username\": \"sarcaxxm\",\n        \"status\": \"active\"\n    }\n}\n```",
    },
    "profile_global_presence": {
