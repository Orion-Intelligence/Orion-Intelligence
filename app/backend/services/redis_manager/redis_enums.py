...
class REDIS_KEYS:
  INSIGHT_OLD_DAY = "INSIGHT_OLD_DAY_v1"
  INSIGHT_NEW_DAY = "INSIGHT_NEW_DAY_v1"
  INSIGHT_STAT = "INSIGHT_STAT"
  INSIGHT_OLD_WEEK = "INSIGHT_OLD_WEEK_v1"
  INSIGHT_NEW_WEEK = "INSIGHT_NEW_WEEK_v1"
  INSIGHT_STAT_WEEK = "INSIGHT_STAT_WEEK_v1"
