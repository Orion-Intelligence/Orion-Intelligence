...
export const FLOW_ENTITY_API_SECTIONS = ['Email Breach', 'Social Scanner', 'Wanted List', 'Playstore Scanner', 'Software Scanner', 'File Scanner', 'Text Analysis', 'Crypto Scanner'];
