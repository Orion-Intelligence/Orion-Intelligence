...
import {
  ...
  ensureDashboardSidebarExpanded,
  openSidebar,
  openAnyMatchingReport,
  selectAndApply,
  selectDateRangeResetAndReopen,
  selectSidebarFilterOption
...
describe('SideBar Filter Verification', () => {
  ...
  //
  //     openSidebar();
  //     selectSidebarFilterOption('side-filter-select-network', option);
  //
  ...
  //     openSidebar();
  //
  //     selectSidebarFilterOption('side-filter-select-content', option);
  //
  //     cy.get('[data-testid="side-filter-apply"]')
  //       .filter(':visible')
  //       .first()
