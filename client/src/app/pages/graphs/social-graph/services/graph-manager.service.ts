...
export class GraphManagerService {
  private readonly relationshipLinkIconPath = '<path fill="#f8fafc" d="M6.354 5.5H4a3 3 0 0 0 0 6h3a3 3 0 0 0 2.83-2h-1.59A1.5 1.5 0 0 1 7 10h-3a1.5 1.5 0 1 1 0-3h2.354a3 3 0 0 1 0-1.5m3.292 5.5H12a3 3 0 1 0 0-6H9a3 3 0 0 0-2.83 2h1.59A1.5 1.5 0 0 1 9 6.5h3a1.5 1.5 0 1 1 0 3H9.646a3 3 0 0 1 0 1.5"/><path fill="#f8fafc" d="M5.5 8a.75.75 0 0 1 .75-.75h3.5a.75.75 0 0 1 0 1.5h-3.5A.75.75 0 0 1 5.5 8"/>';
