...
export class RelationshipResolverService {
  ...
  private addRelationshipConnectionsForDirection(
    sourceUser: string,
    targetUser: string,
    sourcePlatforms: PlatformResult[],
  ...
  private tryAddRelationshipConnection(
    sourceUser: string,
    targetUser: string,
  ...
  buildRelationshipConnections(
    userA: string,
    userB: string,
    scanResults: Map<string, PlatformResult[]>
  ): RelationshipConnectionItem[] {
