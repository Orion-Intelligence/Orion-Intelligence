...
export class FetchingStateService {
  profile = signal<Record<string, boolean>>({});
  posts = signal<Record<string, boolean>>({});
  ...
  setFetching( stateSignal: WritableSignal<Record<string, boolean>>, key: string, isFetching: boolean ) {
