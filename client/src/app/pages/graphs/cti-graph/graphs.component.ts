...
export class GraphComponent implements OnInit, OnDestroy {
    ...
    constructor(private api: ApiService, private clipboard: Clipboard, private route: ActivatedRoute, private graphReportExport: GraphReportExportService, 
    @Inject(PLATFORM_ID)
    ...
    showContextMenu(node: ExtendedNode, pointerDom?: {
        x: number;
        y: number;
    }) {
    ...
    private buildCircularSubNodes(subNodes: string[], centerPos: {
        x: number;
        y: number;
    }, radius: number): ExtendedNode[] {
