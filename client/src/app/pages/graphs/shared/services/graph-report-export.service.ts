...
export class GraphReportExportService {
  ...
  private drawGraphToc( doc: jsPDF, payload: GraphReportPayload, pages: { graphPage: number | null; analysisPage: number; platformPage: number | null; edgesPage: number; } ): void {
    doc.setPage(1);
