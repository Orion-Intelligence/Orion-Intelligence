...
export class PlatformIconBgDirective {
  ...
  private activeColorClass = 'social-mapper-platform-bg-slate';
  ...
  private getColorClassFromHex(hex: string): string
  {
    ...
    if (!/^[0-9a-fA-F]{6}$/.test(normalizedHex)) {
      return 'social-mapper-platform-bg-slate';
    }
    ...
    if (hue < 20 || hue >= 340) {
      return 'social-mapper-platform-bg-red';
    }
    if (hue < 45) {
      return 'social-mapper-platform-bg-orange';
    }
    if (hue < 70) {
      return 'social-mapper-platform-bg-amber';
    }
    if (hue < 160) {
      return 'social-mapper-platform-bg-green';
    }
    if (hue < 200) {
      return 'social-mapper-platform-bg-cyan';
    }
    if (hue < 245) {
      return 'social-mapper-platform-bg-blue';
    }
    if (hue < 300) {
      return 'social-mapper-platform-bg-violet';
    }
    return 'social-mapper-platform-bg-pink';
  }
}
