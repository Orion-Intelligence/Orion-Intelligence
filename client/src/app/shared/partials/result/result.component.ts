...
export class ResultComponent implements OnInit, OnChanges {
    @Input()
    result_count_enabled: boolean = true;
    @Input()
    result_count!: number;
    @Input()
    isLoading!: boolean;
    ...
    @Output()
    reloadSearchFilters = new EventEmitter<FilterCategory[]>();
    @Output()
    reloadFilters = new EventEmitter<Record<string, string | null>>();
    @Output()
    resetFilter = new EventEmitter<void>();
    @Output()
    reloadData = new EventEmitter<void>();
    @Output()
    updateQuery = new EventEmitter<string>();
    @Output()
    onToggleSwitch = new EventEmitter<string>();
    @Output()
    onToggleSort = new EventEmitter<SortType>();
    ...
    @ViewChild('filtersWrapper', { static: false })
    filtersWrapperRef!: ElementRef;
    ...
    init_domains() {
        ...
        let queryDomains = this.helperService.extractLinks(this.searchQuery) || [];
        let filterDomains = Array.isArray(filters['m_domain'])
