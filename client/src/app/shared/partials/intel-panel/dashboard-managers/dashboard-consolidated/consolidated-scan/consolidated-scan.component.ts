...
import { ConsolidatedScanResults, ConsolidatedLiveApiResults, ConsolidatedLiveApis } from '../../../../../model/results/consolidated/consolidated.callback.model';
...
export class ConsolidatedScanComponent {
    ...
    clearResults(options?: {
        keepTargetLabel?: boolean;
        keepExpectedTypes?: boolean;
    }): void {
