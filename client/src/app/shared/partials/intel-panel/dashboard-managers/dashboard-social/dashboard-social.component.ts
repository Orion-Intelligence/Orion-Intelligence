...
import { applyQueryAndPageFromParams, isRouteChanged, resolveSortOrder, setPageAndFetch, updateQuery } from '../dashboard-manager.utils';
@Component({
...
export class DashboardSocialsComponent implements OnInit, AfterViewInit {
    ...
    onToggleSort(sort: SortType) {
        ...
        this.dashboardService.socialCallbackModel.Result = this.helperService.sortByKey<any>(this.dashboardService.socialCallbackModel.Result, 'm_message_date', order);
        this.cdr.detectChanges();
    }
}
