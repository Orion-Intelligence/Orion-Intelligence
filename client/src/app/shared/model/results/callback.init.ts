...
export function initCallbackModel<TRaw, TResult>( target: { Result: TResult[]; Suggestions: Suggestion[]; Page_Count: number; }, init: any | undefined, makeResultItem: (r: Partial<TRaw>) => TResult ) {
  if (!init) {
    return;
  }
