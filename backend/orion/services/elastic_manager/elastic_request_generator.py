...
class elastic_request_generator:
    ...
    def on_search_stealerlogs_data(p_query_model: search_credential_param_model, pFilter, consolidated=False):
        ...
        query = {"query": {"bool": bool_query}, "from": frm, "size": size, "track_total_hits": True, "aggs": {"unique_count": {"cardinality": {"field": "username.keyword", "precision_threshold": 100000}}}, "_source": [
