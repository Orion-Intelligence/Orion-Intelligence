...
class ELASTIC_ENUMS:
    ...
    mapping_opensanctions_model = {"settings": {"number_of_shards": 1, "number_of_replicas": 1, "max_result_window": 1000000}, "mappings": {"dynamic": "true","properties": {"id": {"type": "keyword"},"schema": {"type": "keyword"},"target": {"type": "boolean"},"datasets": {"type": "keyword"},"referents": {"type": "keyword"},"origin": {"type": "keyword"},"caption": {"type": "text"},"name": {"type": "text"},"summary": {"type": "text"},"notes": {"type": "text"},"description": {"type": "text"},"remarks": {"type": "text"},"title": {"type": "text"},"full": {"type": "text"},"subject": {"type": "text"},"object": {"type": "text"},"first_seen": {"type": "date"},"last_seen": {"type": "date"},"last_change": {"type": "date"},"start_date": {"type": "date"},"end_date": {"type": "date"},"listing_date": {"type": "date"},
            "birth_date": {"type": "date"},"modified_at": {"type": "date"},"created_at": {"type": "date"},"incorporation_date": {"type": "date"},"build_date": {"type": "date"},"date": {"type": "date"},"death_date": {"type": "date"},"dissolution_date": {"type": "date"},"country": {"type": "keyword"},"citizenship": {"type": "keyword"},"nationality": {"type": "keyword"},"birth_country": {"type": "keyword"},"city": {"type": "keyword"},"state": {"type": "keyword"},"region": {"type": "keyword"},"street": {"type": "text"},"postal_code": {"type": "keyword"},"address": {"type": "text"},"address_entity": {"type": "text"},"first_name": {"type": "text"},"last_name": {"type": "text"},"middle_name": {"type": "text"},"alias": {"type": "text"},"weak_alias": {"type": "text"},"previous_name": {"type": "text"},
            "abbreviation": {"type": "keyword"},"email": {"type": "keyword"},"phone": {"type": "keyword"},"website": {"type": "keyword"},"entity": {"type": "keyword"},"organization": {"type": "keyword"},"role": {"type": "keyword"},"position": {"type": "keyword"},"legal_form": {"type": "keyword"},"sector": {"type": "keyword"},"jurisdiction": {"type": "keyword"},"classification": {"type": "keyword"},"program": {"type": "keyword"},"program_id": {"type": "keyword"},"program_url": {"type": "keyword"},"authority": {"type": "keyword"},"authority_id": {"type": "keyword"},"source_url": {"type": "keyword"},"issuer": {"type": "keyword"},"publisher": {"type": "keyword"},"id_number": {"type": "keyword"},"record_id": {"type": "keyword"},"registration_number": {"type": "keyword"},"passport_number": {"type": "keyword"},"tax_number": {"type": "keyword"},"inn_code": {"type": "keyword"},"ogrn_code": {"type": "keyword"},"kpp_code": {"type": "keyword"},"okpo_code": {"type": "keyword"},"swift_bic": {"type": "keyword"},"lei_code": {"type": "keyword"},"isin": {"type": "keyword"},"duns_code": {"type": "keyword"},"unsc_id": {"type": "keyword"},"wikidata_id": {"type": "keyword"},"social_security_number": {"type": "keyword"},"asset": {"type": "keyword"},"owner": {"type": "keyword"},"currency": {"type": "keyword"},"ticker": {"type": "keyword"},"managing_exchange": {"type": "keyword"},"imo_number": {"type": "keyword"},"mmsi": {"type": "keyword"},"call_sign": {"type": "keyword"},"tonnage": {"type": "keyword"},"gross_registered_tonnage": {"type": "keyword"},"flag": {"type": "keyword"},"past_flags": {"type": "keyword"},"father_name": {"type": "text"},"mother_name": {"type": "text"},"relative": {"type": "text"},"relationship": {"type": "keyword"},"person": {"type": "keyword"},"member": {"type": "keyword"},
            "status": {"type": "keyword"},"political": {"type": "boolean"},"topics": {"type": "keyword"},"keywords": {"type": "keyword"},"reason": {"type": "text"},"provisions": {"type": "text"},"public_key": {"type": "keyword"},"model": {"type": "keyword"},"serial_number": {"type": "keyword"},"agent": {"type": "keyword"},"client": {"type": "keyword"},"duration": {"type": "keyword"},"holder": {"type": "keyword"}, "index": True}}}
