...
class ELASTIC_ENUMS:
    ...
    mapping_stealer_log_field = {
        ...
        "m_search_all": ["domain.keyword", "domain", "username.keyword", "email.keyword", "bin.keyword", "phone.keyword"]
    }
