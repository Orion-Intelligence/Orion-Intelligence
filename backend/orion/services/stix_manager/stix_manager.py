...
class StixManager:
    ...
    def _convert_defacement(self, raw: DefacementResultItem) -> Dict[str, Any]:
        ...
        def parse_ts(value: Optional[str]) -> Optional[str]:
            if not value:
                return None
            try:
                v = str(value).strip()
        ...
        def add_obj(objects: List[Dict[str, Any]], seen: Dict[Tuple[str, str], str], obj: Dict[str, Any],
        ...
        created = (
                parse_ts(safe_get(raw, "m_leak_date"))
                or parse_ts(safe_get(raw, "m_creation_date"))
                or parse_ts(safe_get(raw, "m_update_date"))
                or now_ts()
        )
        ...
        content_types = set(
            str(x).strip().lower()
            for x in (as_list(safe_get(raw, "m_content_type")) + as_list(safe_get(raw, "content_type")))
            if str(x).strip()
        )
        ...
        for c in (as_list(safe_get(raw, "m_country")) or as_list(safe_get(raw, "m_location"))):
            ...
            loc = {
                "type": "location",
                "spec_version": "2.1",
                "id": stix_id("location", f"country:{cc}"),
                "created": created,
                "modified": modified,
                "name": cc,
                "country": cc,
        ...
        if infra_seed:
            infra = {
                "type": "infrastructure",
                "spec_version": "2.1",
                "id": stix_id("infrastructure", f"infra:{infra_seed}"),
                "created": created,
                "modified": modified,
                "name": title,
        ...
        if sco_refs:
            obs = {
                ...
                "number_observed": 1,
                "object_refs": sorted(set(sco_refs)),
                "object_marking_refs": [tlp_amber_id],
            }
        ...
        for c in as_list(safe_get(raw, "m_cve")):
            ...
            if token.startswith("CVE-"):
                v = {
                    "type": "vulnerability",
                    "spec_version": "2.1",
                    "id": stix_id("vulnerability", token),
                    "created": created,
                    "modified": modified,
                    "name": token,
                    "external_references": [
                ...
                if cwe_num.isdigit():
                    v = {
                        ...
                        "name": token,
                        "external_references": [
                            {"source_name": "cwe", "external_id": token,
        ...
        for tech in sorted(set(techniques)):
            ...
            ap: Dict[str, Any] = {
                "type": "attack-pattern",
                "spec_version": "2.1",
                "id": stix_id("attack-pattern", tech),
                "created": created,
                "modified": modified,
                "name": tech,
                "external_references": [{"source_name": "mitre-attack", "external_id": tech,
                                         "url": f"https://attack.mitre.org/techniques/{base}/"}],
                "kill_chain_phases": [{"kill_chain_name": "mitre-attack", "phase_name": t} for t in
                                      sorted(set(tactics))] if tactics else None,
                "object_marking_refs": [tlp_amber_id],
            }
        ...
        report: Dict[str, Any] = {
            "type": "report",
            "spec_version": "2.1",
            "id": stix_id("report", f"defacement:{doc_id}"),
            "created": created,
            "modified": modified,
            "name": title,
            "description": summary if summary else None,
            ...
            "object_refs": sorted(set(report_object_refs)),
            "object_marking_refs": [tlp_amber_id],
    ...
    def _convert_exploit(self, raw: ExploitResultItem) -> Dict[str, Any]:
        ...
        created = (
                parse_ts(safe_get(raw, "m_creation_date"))
                or parse_ts(safe_get(raw, "m_update_date"))
                or parse_ts(safe_get(raw, "m_leak_date"))
                or now_ts()
        )
        modified = parse_ts(safe_get(raw, "m_update_date")) or created
        if modified < created:
        ...
        title = str(first_nonempty(safe_get(raw, "m_title"), safe_get(raw, "m_url"), safe_get(raw, "m_weblink"),
        ...
        if infra_seed:
            ...
            infra = {
                ...
                "created": created,
                "modified": modified,
                "name": str(first_nonempty(titled := title, safe_get(raw, "m_name"), "Exploit infrastructure")),
                "description": summary if summary else None,
        ...
        if sensitive:
            note = {
                "type": "note",
                "spec_version": "2.1",
                "id": stix_id("note", f"sensitive|{doc_id}|{created}"),
                "created": created,
                "modified": modified,
                "abstract": "Sensitive artifacts (hashed)",
                "content": str(sensitive),
        ...
        report: Dict[str, Any] = {
            "type": "report",
            "spec_version": "2.1",
            "id": stix_id("report", f"exploit:{doc_id}"),
            "created": created,
            "modified": modified,
            "name": title,
            "description": summary if summary else None,
    ...
    def _convert_leak(self, raw: LeakResultItem) -> Dict[str, Any]:
        ...
        title = str(first_nonempty(safe_get(raw, "m_title"), safe_get(raw, "m_url"), safe_get(raw, "m_base_url"),
                                   "Leak - unknown title"))
        ...
        for vref in victim_refs:
            for lref in location_refs:
                rel = {
                    "type": "relationship",
                    "spec_version": "2.1",
                    "id": stix_id("relationship", f"{vref}|located-at|{lref}"),
                    "created": created,
                    "modified": modified,
        ...
        infra_seed = first_nonempty(base_url, url, (
            as_list(safe_get(raw, "m_domain"))[0] if as_list(safe_get(raw, "m_domain")) else None))
        infra_ref = None
        if infra_seed:
            infra_types = ["unknown"]
            ...
            infra = {
                ...
                "created": created,
                "modified": modified,
                "name": str(first_nonempty(safe_get(raw, "m_team"), title, "Leak infrastructure")),
                "description": summary if summary else None,
                "infrastructure_types": infra_types,
                "first_seen": created,
                "last_seen": modified,
        ...
        report: Dict[str, Any] = {
            "type": "report",
            "spec_version": "2.1",
            "id": stix_id("report", f"leak:{doc_id}"),
            "created": created,
            "modified": modified,
            "name": title,
            "description": summary if summary else None,
    ...
    def _convert_social(self, raw: SocialResultItem) -> Dict[str, Any]:
        ...
        created = (
                parse_ts(safe_get(raw, "m_creation_date"))
                or parse_ts(safe_get(raw, "m_update_date"))
                or parse_ts(safe_get(raw, "m_message_date"))
                or now_ts()
        )
        modified = parse_ts(safe_get(raw, "m_update_date")) or created
        if modified < created:
        ...
        title = str(first_nonempty(safe_get(raw, "m_title"), safe_get(raw, "m_url"), safe_get(raw, "m_channel_url"),
                                   "Social - unknown title"))
        url = first_nonempty(safe_get(raw, "m_message_sharable_link"), safe_get(raw, "m_channel_url"),
                             safe_get(raw, "m_url"))
        ...
        content_src = first_nonempty(safe_get(raw, "m_content"), safe_get(raw, "m_important_content"),
                                     safe_get(raw, "m_meta_description"), "")
        summary = clean_text(str(content_src or ""))
        if len(summary) > 4000:
            summary = summary[:4000] + "…"
        ...
        if infra_seed:
            ...
            infra = {
                ...
                "created": created,
                "modified": modified,
                "name": str(first_nonempty(platform, title, "Social infrastructure")),
                "description": summary if summary else None,
                "infrastructure_types": infra_types,
                "first_seen": created,
                "last_seen": modified,
        ...
        if sensitive or hashtags or mentions:
            ...
            note = {
                "type": "note",
                "spec_version": "2.1",
                "id": stix_id("note", f"social-meta|{doc_id}|{created}"),
                "created": created,
                "modified": modified,
        ...
        report: Dict[str, Any] = {
            "type": "report",
            "spec_version": "2.1",
            "id": stix_id("report", f"social:{doc_id}"),
            "created": created,
            "modified": modified,
            "name": title,
            "description": summary if summary else None,
            ...
            "x_orion_network": str(network) if network else None,
            "x_orion_platform": str(platform) if platform else None,
            "x_orion_post_comments_count": str(safe_get(raw, "m_post_comments_count")) if safe_get(raw,
                                                                                                   "m_post_comments_count") else None,
        }
        report = {k: v for k, v in report.items() if v is not None}
        add_obj(objects, seen, report, uniq=("report", report["id"]))
    ...
    def _convert_general(self, raw: GeneralResultItem) -> Dict[str, Any]:
        ...
        summary_src = first_nonempty(safe_get(raw, "m_important_content"), safe_get(raw, "m_meta_description"),
                                     safe_get(raw, "m_content"), "")
        ...
        if infra_seed:
            ...
            infra = {
                ...
                "created": created,
                "modified": modified,
                "name": str(first_nonempty(safe_get(raw, "m_team"), title, "Observed infrastructure")),
                "description": summary if summary else None,
                "infrastructure_types": infra_types,
                "first_seen": created,
                "last_seen": modified,
    ...
    def _convert_chat(self, raw: ChatResultItem) -> Dict[str, Any]:
        ...
        doc_id = first_nonempty(safe_get(raw, "m_document_id"), safe_get(raw, "m_hash"), safe_get(raw, "m_message_id"),
                                url, channel_id, caption)
        ...
        if infra_seed:
            ...
            infra = {
                "type": "infrastructure",
                "spec_version": "2.1",
                "id": stix_id("infrastructure", f"channel:{infra_seed}"),
                "created": created,
                "modified": modified,
        ...
        if sensitive or hashtags or mentions:
            ...
            note = {
                "type": "note",
                "spec_version": "2.1",
                "id": stix_id("note", f"chat-meta|{doc_id}|{created}"),
                "created": created,
                "modified": modified,
        ...
        report: Dict[str, Any] = {
            "type": "report",
            "spec_version": "2.1",
            "id": stix_id("report", f"chat:{doc_id}"),
            "created": created,
            "modified": modified,
            "name": caption,
            "description": summary if summary else None,
            ...
            "x_orion_sender_is_bot": bool(safe_get(raw, "m_sender_is_bot")) if safe_get(raw,
                                                                                        "m_sender_is_bot") is not None else None,
            "x_orion_is_forwarded": bool(safe_get(raw, "m_is_forwarded")) if safe_get(raw,
