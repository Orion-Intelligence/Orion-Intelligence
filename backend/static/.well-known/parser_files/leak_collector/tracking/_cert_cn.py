...
class _cert_cn(leak_extractor_interface, ABC):
    ...
    def rule_config(self) -> RuleModel:
        return RuleModel(
            m_fetch_proxy=FetchProxy.NONE, m_fetch_config=FetchConfig.REQUESTS, m_threat_type=ThreatType.TRACKING)
    ...
    def parse_leak_data(self, page):
        try:
            ...
            current_html = seed_resp.text if seed_resp and hasattr(seed_resp, "text") else page.get(
                self.seed_url, timeout=60).text
