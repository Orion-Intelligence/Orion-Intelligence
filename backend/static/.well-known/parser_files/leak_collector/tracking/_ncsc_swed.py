...
class _ncsc_swed(leak_extractor_interface, ABC):
    _instance = None
    ...
    def __new__(cls, callback=None):
        if cls._instance is None:
            cls._instance = super(_ncsc_swed, cls).__new__(cls)
    ...
    def seed_url(self) -> str:
        return "https://www.ncsc.admin.ch/ncsc/en/home/aktuell/im-fokus.html"
    ...
    def base_url(self) -> str:
        return "https://www.ncsc.admin.ch/"
    ...
    def contact_page(self) -> str:
        return "https://www.ncsc.admin.ch/ncsc/en/home/ueber-ncsc/kontakt.html"
            ...
            for link_url in all_links:
                try:
                    ...
                    entity_data = entity_model(
                        m_scrap_file=self.__class__.__name__, m_team="ncsc", m_country=["switzerland"])
