...
class _incibe(leak_extractor_interface, ABC):
    _instance = None
    ...
    def __new__(cls, callback=None):
        if cls._instance is None:
            cls._instance = super(_incibe, cls).__new__(cls)
    ...
    def seed_url(self) -> str:
        return "https://www.incibe.es/en/incibe-cert/blog"
    ...
    def base_url(self) -> str:
        return "https://www.incibe.es/en/incibe-cert"
    ...
    def contact_page(self) -> str:
        return "https://www.incibe.es/en/incibe/contact"
