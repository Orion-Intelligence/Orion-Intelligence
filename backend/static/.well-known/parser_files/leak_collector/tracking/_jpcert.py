...
class _jpcert(leak_extractor_interface, ABC):
  _instance = None
  ...
  def __new__(cls, callback=None):
    if cls._instance is None:
      cls._instance = super(_jpcert, cls).__new__(cls)
  ...
  def seed_url(self) -> str:
    return "https://blogs.jpcert.or.jp/en/"
  ...
  def base_url(self) -> str:
    return "https://www.jpcert.or.jp/english/"
  ...
  def contact_page(self) -> str:
    return "https://www.jpcert.or.jp/english/about/"
      ...
      for idx, url in enumerate(all_urls):
        try:
          ...
          entity_data = entity_model(
            m_scrap_file=self.__class__.__name__, m_team="jpcert", m_country=["Japan"])
