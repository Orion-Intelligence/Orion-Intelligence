...
class _nukibgovcz(leak_extractor_interface, ABC):
    _instance = None
    ...
    def __new__(cls, callback=None):
        if cls._instance is None:
            cls._instance = super(_nukibgovcz, cls).__new__(cls)
    ...
    def seed_url(self) -> str:
        return "https://nukib.gov.cz/en/infoservis-en/news/"
    ...
    def contact_page(self) -> str:
        return "https://nukib.gov.cz/en/contacts/"
            ...
            for url in unique_urls:
                try:
                    ...
                    entity_data = entity_model(
                        m_scrap_file=self.__class__.__name__, m_team="nukib-gov-cz", m_country=["czech"])
