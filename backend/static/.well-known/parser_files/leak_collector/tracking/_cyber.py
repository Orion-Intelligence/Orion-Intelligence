...
class _cyber(leak_extractor_interface, ABC):
    _instance = None
    ...
    def __new__(cls, callback=None):
        ...
        if cls._instance is None:
            cls._instance = super(_cyber, cls).__new__(cls)
    ...
    def seed_url(self) -> str:
        ...
        return "https://cyber.gouv.fr/en/actualites"
    ...
    def contact_page(self) -> str:
        ...
        return "https://www.cert.ssi.gouv.fr/contact/"
            ...
            while True:
                ...
                for url in post_links:
                    try:
                        ...
                        description = "\n".join(
                            p.get_text(strip=True) for p in desc_paragraphs if p.get_text(strip=True))
