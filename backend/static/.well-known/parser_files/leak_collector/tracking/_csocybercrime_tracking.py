    ...
    try:
      ...
      for idx, link in enumerate(list(all_links), 1):
        try:
          ...
          content_text = "No content found." if not text_blocks else "\n".join(text_blocks)
          ...
          entity_data = entity_model(
            m_scrap_file=self.__class__.__name__, m_team="CSO Cybercrime Section", m_country=["united kingdom"], )
