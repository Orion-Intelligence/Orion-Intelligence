      ...
      for card in cards:
        try:
          ...
          if more_info_url:
            ...
            all_links = [link.get_attribute('href') for section_id in ['#Negotiat', '#listing-files', '#files'] for link
              in more_info_page.query_selector_all(f'{section_id} + .section ul a')]
