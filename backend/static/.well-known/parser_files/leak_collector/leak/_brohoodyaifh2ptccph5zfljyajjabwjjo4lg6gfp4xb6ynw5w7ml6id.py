  ...
  def parse_leak_data(self, page: Page):
    ...
    for btn in buttons:
      try:
        ...
        images = [urljoin(self.base_url, img.get_attribute("src")) for img in body.query_selector_all("img") if
          img.get_attribute("src")]

        links = [urljoin(self.base_url, a.get_attribute("href")) for a in body.query_selector_all("a") if
          a.get_attribute("href") and urljoin(self.base_url, a.get_attribute("href")) != site_link]
        ...
        entity_data = entity_model(
          m_scrap_file=self.__class__.__name__, m_team="BROTHERHOOD", m_industry=organization, m_country=[country], )
