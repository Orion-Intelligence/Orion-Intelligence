    ...
    def parse_leak_data(self, page: Page):
        ...
        while True:
            ...
            try:
                ...
                dumplinks = [link.get_attribute("href") for link in
                    page.query_selector_all("a[class*='text-[#3EA5EE]']") if link.get_attribute("href")]

                image_links = [img.get_attribute("src") for img in page.query_selector_all("div.gallery-inner img") if
                    img.get_attribute("src")]

                weblinks = [link.get_attribute("href") for link in
                    page.query_selector_all("a.text-\\[\\#3ea4ee\\].text-lg.font-medium.leading-\\[27px\\]") if
                ...
                entity_data = entity_model(
                    m_scrap_file=self.__class__.__name__, m_team="bert", m_company_name=title, m_confidence=["high"], )
