...
class _genesis6ixpb5mcy4kudybtw5op2wqlrkocfogbnenz3c647ibqixiad(leak_extractor_interface, ABC):
  ...
  def __new__(cls, callback=None):
    if cls._instance is None:
      cls._instance = super(
        _genesis6ixpb5mcy4kudybtw5op2wqlrkocfogbnenz3c647ibqixiad, cls).__new__(cls)
  ...
  def rule_config(self) -> RuleModel:
    return RuleModel(
      m_fetch_proxy=FetchProxy.TOR, m_fetch_config=FetchConfig.PLAYRIGHT, m_threat_type=ThreatType.LEAK, )
  ...
  def parse_leak_data(self, page: Page):
    ...
    for link in full_links:
      ...
      entity_data = entity_model(
        m_scrap_file=self.__class__.__name__, m_team="GENESIS")
