        ...
        try:
            ...
            def collect_links(section_name, match_path):
                ...
                while len(links) < testing_limit:
                    ...
                    new_links = [urljoin(self.base_url, a.get_attribute("href")) for a in
                        page.query_selector_all("tbody tr td a") if
                        a.get_attribute("href") and match_path in a.get_attribute("href")]
            ...
            main_nav_links = {nav.inner_text().strip(): nav.get_attribute("href") for nav in
                page.query_selector_all("a.nav-link.link-light.btn.btn-secondary")}
            ...
            for incident_url in incident_links:
                try:
                    ...
                    desc_el = page.query_selector("div.container div.row div.col") or page.query_selector(
                        "div.p-2, p.p-2")
                    ...
                    build_card(
                        title.inner_text().strip() if title else None,
                        incident_url,
                        desc_text,
                        desc_text,
                        websites,
