            ...
            for link in href_links:
                try:
                  ...
                  return -1;
                    ...
                    ref_html = helper_method.extract_refhtml(m_weblinks, self.invoke_db, REDIS_COMMANDS, CUSTOM_SCRIPT_REDIS_KEYS, RAW_PATH_CONSTANTS)
                    ...
                    entity_data = helper_method.extract_entities(m_description + (ref_html or ""), entity_data)
