            ...
            for link in href_links:
                try:
                    ...
                    ref_html = helper_method.extract_refhtml(
                        m_weblinks, self.invoke_db, REDIS_COMMANDS, CUSTOM_SCRIPT_REDIS_KEYS, RAW_PATH_CONSTANTS, page)
                    ...
                    entity_data = entity_model(
                        m_scrap_file=self.__class__.__name__, m_company_name=title, m_team="nitrogen")
