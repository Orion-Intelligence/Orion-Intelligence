  ...
  def parse_leak_data(self, page: Page):
    try:
      ...
      for c in cards:
        ...
        items.append({"title": title, "country": country, "published_text": published_text, **summary_map})
      ...
      for it in items:
        ...
        if clicked:
          ...
          if ad:
            ...
            summary_map = {"Company": article_company, "Website": article_website, "Industry": article_industry, "Data Size": article_data_size, "Leaked Data Types": article_content}
