          ...
          for card in cards:
            ...
            try:
              ...
              page.wait_for_function(
                "el => el && el.innerText.trim().length > 0", arg=page.query_selector('.detailed p'), timeout=15000)
              ...
              images = [self.base_url + img.get_attribute('src') for img in
                page.query_selector_all('.disclosured__images img') if img.get_attribute('src')]
              ...
              entity_data = entity_model(
                m_scrap_file=self.__class__.__name__, m_company_name=title, m_team="lynx")
