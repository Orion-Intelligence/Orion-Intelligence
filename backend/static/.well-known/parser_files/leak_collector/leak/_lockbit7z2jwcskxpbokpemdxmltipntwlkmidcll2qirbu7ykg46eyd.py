...
class _lockbit7z2jwcskxpbokpemdxmltipntwlkmidcll2qirbu7ykg46eyd(leak_extractor_interface, ABC):
  ...
  def parse_leak_data(self, page: Page):
    try:
      ...
      post_urls = [self.base_url + link.get_attribute("href") for link in post_links if link.get_attribute("href")]
      ...
      for link in post_urls:
        try:
          ...
          entity_data = entity_model(
            m_scrap_file=self.__class__.__name__, m_weblink=[title], m_team="lockbit")
