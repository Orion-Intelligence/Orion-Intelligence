        ...
        try:
            ...
            for card in card_elements:
                try:
                    ...
                    description = description_element.inner_text().replace(
                        "Description:", "").strip() if description_element else ""
                    ...
                    company_name = company_name_element.inner_text().replace(
                        "Company name:", "").strip() if company_name_element else ""
                    ...
                    entity_data = entity_model(
                        m_scrap_file=self.__class__.__name__, m_company_name=company_name, m_team="trinity")
