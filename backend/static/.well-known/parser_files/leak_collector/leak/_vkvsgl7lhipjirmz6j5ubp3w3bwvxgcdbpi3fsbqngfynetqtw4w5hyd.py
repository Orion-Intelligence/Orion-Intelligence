    ...
    for link_url in title_urls_list:
      try:
        ...
        ref_html = helper_method.extract_refhtml(
          title_text, self.invoke_db, REDIS_COMMANDS, CUSTOM_SCRIPT_REDIS_KEYS, RAW_PATH_CONSTANTS, page)
        ...
        entity_data = entity_model(
          m_scrap_file=self.__class__.__name__, m_company_name=title_text, m_team="brain cipher")
