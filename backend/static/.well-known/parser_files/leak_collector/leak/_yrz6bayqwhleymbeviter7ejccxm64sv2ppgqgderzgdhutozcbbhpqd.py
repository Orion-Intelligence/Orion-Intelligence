    ...
    for card_url, leak_date in card_links:
      try:
        ...
        try:
          ...
          explore_data_link = (
            self.base_url + explore_data_link_tag["href"] if explore_data_link_tag and explore_data_link_tag.has_attr(
              "href") else "")
          ...
          entity_data = entity_model(
            m_scrap_file=self.__class__.__name__, m_country=[country], m_company_name=page.title(), m_team="apos blog")
