  ...
  def parse_leak_data(self, page: Page):
    ...
    for index, link in enumerate(title_links):
      try:
        ...
        try:
          action_date = (
            datetime.strptime(action_date_text, "%d/%m/%Y").date() if action_date_text != "Unknown" else None)
        except ValueError:
          action_date = None
        ...
        entity_data = entity_model(
          m_scrap_file=self.__class__.__name__, m_team="ransome house", m_social_media_profiles=social_links, )
