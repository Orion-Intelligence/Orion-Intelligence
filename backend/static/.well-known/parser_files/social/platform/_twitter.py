...
class _twitter(leak_extractor_interface, ABC):
    ...
    def rule_config(self) -> RuleModel:
        return RuleModel(
            m_fetch_proxy=FetchProxy.NONE, m_fetch_config=FetchConfig.PLAYRIGHT, m_threat_type=ThreatType.TWITTER)
    ...
    def parse_leak_data(self, page):
        ...
        for tweet in new_tweets:
            ...
            entity_data = entity_model(
                m_scrap_file=self.__class__.__name__, m_name=username, )
