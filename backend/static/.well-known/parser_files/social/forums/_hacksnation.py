...
class _hacksnation(leak_extractor_interface, ABC):
  ...
  def parse_leak_data(self, page):
    forbidden_keywords = ["porn", "onlyfans", "sex", "horny", "pornography", "adult", "escort", "camgirl", "cam boy",
      "nudes", "nude", "xxx", "fetish", "bdsm", "pornhub", "stripchat", "livejasmin", "snapchat", "chaturbate", "leak",
      "incest", "taboo", "hardcore", "erotica", "sexcam", "adultwork", "escortservice", "hooker", "prostitute", "anal",
      "oral", "cum", "blowjob", "handjob", "dildo", "vibrator", "orgy", "gangbang", "deepfake", "onlyfansleak",
      "fansly", "amateur", "spank", "lust", "suck", "slut", "whore", "milf", "teen", "lolita", "hentai", "futa",
      "sextape", "sex tape"]
    ...
    for item in to_parse:
      try:
        ...
        entity_data = entity_model(
          m_scrap_file=self.__class__.__name__, m_username=m_username, m_code_snippet=code)
