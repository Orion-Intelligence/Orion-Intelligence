        ...
        try:
            ...
            for link in urls:
                ...
                content = helper_method.extract_refhtml_requests(
                    link, self.invoke_db, REDIS_COMMANDS, CUSTOM_SCRIPT_REDIS_KEYS, RAW_PATH_CONSTANTS, page)
                ...
                entity_data = entity_model(
                    m_scrap_file=self.__class__.__name__, m_team="openphish", m_weblink=[link])
