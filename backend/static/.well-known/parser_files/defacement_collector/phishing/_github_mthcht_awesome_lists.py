...
class _github_mthcht_awesome_lists(leak_extractor_interface, ABC):
    ...
    def seed_url(self) -> str:
        return "https://github.com/mthcht/awesome-lists/blob/main/Lists/Phishing/openphish/openphish_url_list.csv"
    ...
    def rule_config(self) -> RuleModel:
        return RuleModel(
            m_fetch_proxy=FetchProxy.NONE, m_fetch_config=FetchConfig.REQUESTS, m_threat_type=ThreatType.DEFACEMENT)
    ...
    def contact_page(self) -> str:
        return "https://github.com/mthcht/awesome-lists/blob/main/Lists/"
        ...
        if not urls:
            ...
            for row in rows:
                ...
                if u:
                    urls.append(u)
        for url in urls:
            content = helper_method.extract_refhtml_requests(
                url, self.invoke_db, REDIS_COMMANDS, CUSTOM_SCRIPT_REDIS_KEYS, RAW_PATH_CONSTANTS, page)
            ...
            entity_data = entity_model(
                m_scrap_file=self.__class__.__name__, m_team="mthcht", )
