    ...
    def parse_leak_data(self, page: Page):
        ...
        while current_page <= max_pages:
            try:
                ...
                mirror_links = [
                    urljoin(self.base_url, row.query_selector("td.center a").get_attribute("href"))
                    for row in page.query_selector_all("table tbody tr")
                    if row.query_selector("td.center a")
                ]
                ...
                for mirror_url in mirror_links:
                    ...
                    try:
                        ...
                        target_url = header.split("Defacement Detail of")[
                            -1].strip() if "Defacement Detail of" in header else ""
                        ...
                        content = helper_method.extract_refhtml(
                            ip, self.invoke_db, REDIS_COMMANDS, CUSTOM_SCRIPT_REDIS_KEYS, RAW_PATH_CONSTANTS,
                            mirror_page
                        )
