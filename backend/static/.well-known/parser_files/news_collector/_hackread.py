...
class _hackread(leak_extractor_interface, ABC):
    ...
    def parse_leak_data(self, page):
        try:
            ...
            session = page
            urls_to_visit = []
            categories = ["https://hackread.com/category/latest-cyber-crime/",
                "https://hackread.com/category/security/", "https://hackread.com/category/hacking-news/", ]
            ...
            for link_url in urls_to_visit:
                try:
                    ...
                    title_el = s.select_one("h1.cs-entry__title.cs-entry__title-line") or s.select_one(
                        "h1.cs-entry__title")
                    ...
                    article_date = datetime.strptime(
                        ...
                        "%B %d, %Y").date() if date_el else None
                    ...
                    entity_data = entity_model(
                        m_scrap_file=self.__class__.__name__, m_team="hackread")
