  ...
  def parse_leak_data(self, page):
    ...
    try:
      ...
      for _ in range(max_pages):
        ...
        selectors = [".blog-posts .body-post a.story-link[href]", ".body-post a.story-link[href]", "article h2 a[href]",
          ".post-title a[href]", "h2.post-title a[href]", "a[href*='/20']", ".article-title a[href]",
          "h3 a[href*='/']", ]
