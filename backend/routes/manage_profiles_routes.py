...
async def trigger_hate_speech_monitoring(profile_id: str, current_user=Depends(get_current_user)):
    return await ProfileManager.get_instance().trigger_hate_speech_monitoring(current_user, profile_id)
