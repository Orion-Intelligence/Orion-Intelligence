SYSTEM_INFO_DOCS = {"directory": {"description": (
    ...
    "insight": {"description": (
        ...
        "as well as graph-style aggregations such as top teams, locations, and hashtags."), "response_description": (
        ...
        '        "key": "Languages Tagged",\n'
        '        "value": 3,\n'
        '        "change_weekly": "0%",\n'
        '        "change_daily": "0%"\n'
        '      },\n'
        '      "phone_document_count": {\n'
        '        "key": "Organizations Tagged",\n'
        '        "value": 80,\n'
        '        "change_weekly": "0%",\n'
        '        "change_daily": "0%"\n'
        '      },\n'
        '      "clearnet_document_count": {\n'
        '        "key": "Countries Tagged",\n'
        '        "value": 68,\n'
        '        "change_weekly": "0%",\n'
        '        "change_daily": "0%"\n'
        '      },\n'
...
REPORT_DOCS = {"defacement": {"description": (
    ...
    "```"), "response_description": (
                                        ...
                                        "  \"Page_Count\": 1.2\n"
                                        "}\n"
                                        "```") + IOC_DOC, }, "stix": {"description": (
    "Return a **STIX 2.1 bundle** for a single document.\n\n"
    "This endpoint converts a tenant document into a STIX 2.1 `bundle` (spec_version `2.1`) containing:\n"
    ...
    "- `report.external_references` includes the source URL (when available) and content hash.\n"
    "- Tenant metadata is exported using `x_tenant_*` properties on relevant objects.\n\n"
    "Minimal example request:\n"
    "```json\n"
    "{\n"
    ...
    "  \"lang\": \"en\"\n"
    "}\n"
    "```"), "response_description": ("A STIX 2.1 bundle matching the structure below.\n\n"
                                     "Top-level response fields:\n"
                                     "- **type**: `bundle`\n"
                                     "- **id**: `bundle--<uuid>`\n"
                                     "- **spec_version**: `2.1`\n"
                                     "- **x_tenant_name**: configured tenant application name\n"
                                     ...
                                     "      \"labels\": [\"leaks\", \"marketplaces\", \"onion\", \"tenant-name:general\"],\n"
                                     "      \"object_marking_refs\": [\"marking-definition--...\"],\n"
                                     "      \"x_tenant_network\": \"onion\"\n"
                                     "    },\n"
                                     "    {\n"
                                     "      \"type\": \"url\",\n"
                                     "      \"id\": \"url--...\",\n"
    ...
    "No request body is required."), "response_description": (
...
DYNAMIC_DOCS = {"dynamic_user_email": {"description": (
    ...
    "for the exposure search."), "response_description": (
    ...
    "one breach collection or dataset."), }, "dynamic_cracked": {"description": (
    ...
    "artifacts should be discovered."), "response_description": (
    ...
    "version and metadata."), }, "dynamic_social": {"description": (
    ...
    "and breach-related datasets."), "response_description": (
    ...
    "platforms or in various breach-related datasets."), }, "domain_scan": {"description": (
    ...
    "  - **Scanned_by**       — scanner identity (the configured tenant name)\n\n"
...
SEARCH_DOCS = {"defacement": {"description": (
    ...
    "social": {"description": (
        ...
        "are lists of values that documents must/may contain depending on **must**."), "response_description": (
        ...
        "own total and list of matching documents and is suitable for driving dashboards and per-section drill-down."), "response_description": (
        ...
        "metadata fields like **doc_id**, **m_title**, **m_network**, **m_content_type**, and hash/timestamp fields."), }, "consolidated_ranked": {"description": (
        ...
        "underlying report API."), "response_description": (
        ...
        "metadata to call the corresponding detailed report endpoints."), }, "strategic": {"description": (
