...
@api_routes.get("/api/directory", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO, user_role.PROFILE]))],
...
@api_routes.get("/api/dumps", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO, user_role.PROFILE])),Depends(license_required("module:dumps"))],
                description="Fetch the directory listing with optional filters for categories, types, or tags.")
...
@api_routes.post("/api/search/strategic", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO, user_role.PROFILE])),Depends(license_required("module:general"))],
...
@api_routes.post("/api/search/stealerlogs", dependencies=[Depends(role_required([user_role.ADMIN, user_role.PROFILE, user_role.DEMO])),Depends(license_required("module:stealer_logs"))])
...
@api_routes.post("/api/chat/telegram", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO, user_role.PROFILE])),Depends(license_required("module:social"))])
...
@api_routes.post("/api/search/discussion", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO, user_role.PROFILE])),Depends(license_required("module:discussion"))],
...
@api_routes.post("/api/exploit/discussion", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO, user_role.PROFILE])),Depends(license_required("module:exploit"))])
...
@api_routes.post("/api/social/all", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO, user_role.PROFILE])), Depends(license_required("module:social"))])
async def search_discussion(param: search_general_param_model = Body(...)):
    base_index = [
        ELASTIC_INDEX.S_CHATS_INDEX,
        ELASTIC_INDEX.S_SOCIAL_INDEX
...
@api_routes.post("/api/social", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO, user_role.PROFILE])), Depends(license_required("module:social"))])
...
@api_routes.post("/api/search/breach", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO, user_role.PROFILE])),Depends(license_required("module:breach"))],
                 description="Search breach (leak) intelligence reports using parameters such as company, country, or hash.")
async def search_leak(param: search_leak_param_model = Body(...)):
    if param.category in ['all']:
        base_index = [
...
@api_routes.post("/api/search/news", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO, user_role.PROFILE]))],
...
@api_routes.post("/api/search/exploit", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO, user_role.PROFILE])),Depends(license_required("module:exploit"))],
                 description="Search breach (leak) intelligence reports using parameters such as company, country, or hash.")
async def search_leak(param: search_leak_param_model = Body(...)):
    return await search_model.getInstance().search_exploit_result(param)


@api_routes.post("/api/search/defacement", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO, user_role.PROFILE])),Depends(license_required("module:defacement"))],
...
@api_routes.get("/api/search/news/{doc_id}", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO, user_role.PROFILE]))],
                description="Get a specific breach (leak) document by its document ID and optional language.")
async def get_leak_document(doc_id: str, lang: Optional[str] = Query(None, alias="lang")):
    return await search_model.getInstance().request_leak_doc(doc_id, lang)
...
@api_routes.post("/api/dynamic/user", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO, user_role.PROFILE])), Depends(license_required("scanning"))],
...
@api_routes.post("/api/dynamic/cracked", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO, user_role.PROFILE])), Depends(license_required("scanning"))],
                 description="Perform a dynamic search for emails found in breach and defacement data.")
async def search_dynamic_email(param: search_dynamic_param_model = Body(...)):
...
@api_routes.post("/api/dynamic/social", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO, user_role.PROFILE])), Depends(license_required("scanning"))],
                 description="Perform a dynamic search for emails found in breach and defacement data.")
async def search_dynamic_email(param: search_dynamic_param_model = Body(...)):
    return await search_model.getInstance().dynamic_search(param, "social")


@api_routes.get("/api/search/breach/screenshot/{filename}", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO, user_role.PROFILE])), Depends(license_required("module:breach"))],
