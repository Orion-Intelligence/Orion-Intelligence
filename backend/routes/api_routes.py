...
from orion.view_managers.interactive.search_manager.search_data_model.search_dynamic_param_model import search_dynamic_param_model
from orion.view_managers.interactive.search_manager.search_data_model.search_api_general_param_model import search_general_param_model
...
async def parser(request: Request, param: search_api_leak_param_model = Depends()):
