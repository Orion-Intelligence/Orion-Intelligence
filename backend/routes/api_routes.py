...
@api_routes.get("/api/search/strategic/{doc_id}", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO]))])
...
@api_routes.get("/api/search/breach/screenshot/{filename}", dependencies=[Depends(role_required([user_role.ADMIN, user_role.DEMO]))])
