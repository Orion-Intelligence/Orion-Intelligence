...
class migration_1_0_3_7:
    ...
    async def migrate(version):
        ...
        for index in migration_1_0_3_7.PLATFORM_LIST_INDICES:
            await migration_1_0_3_7.migrate_index(es, index)

        await migration_1_0_3_7.update_version(engine, version)
