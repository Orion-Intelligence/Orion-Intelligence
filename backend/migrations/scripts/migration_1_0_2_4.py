...
class migration_1_0_2_4:

  @staticmethod
  async def migrate(version):
    index_list = [ELASTIC_INDEX.S_LEAK_INDEX, ELASTIC_INDEX.S_DEFACEMENT_INDEX, ELASTIC_INDEX.S_GENERIC_INDEX,
      ELASTIC_INDEX.S_CHATS_INDEX]

    for index_name in index_list:
      await migration_1_0_2_4.update_mapping(index_name)
  ...
  async def update_mapping(index_name):
    ...
    new_mapping = {"properties": {"m_ref_html": {"type": "text"}}}
